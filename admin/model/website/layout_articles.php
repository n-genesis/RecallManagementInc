<?php
class ModelWebsiteLayoutArticles extends Model {
	public function addInformation($data) {
        ...
        if (isset($data['image'])) {
            $this->db->query("INSERT INTO " . DB_PREFIX . "information_image SET image = '" . $this->db->escape($data['image']) . "', information_id = '" . (int)$information_id . "'");
        }
    ...
    public function getInformationsImages($information_id) {
        $query = $this->db->query("SELECT image FROM " . DB_PREFIX . "information_image WHERE information_id = '" . (int)$information_id . "'");
