...
class ControllerCustomerCustomer extends Controller {
	...
	protected function getForm() {
		...
		$data['button_history_add'] = $this->language->get('Send Message');
	...
	public function addHistory() {
		...
		if (!$this->user->hasPermission('modify', 'customer/customer')) {
			...
			$this->model_customer_customer->addHistory($this->request->get['customer_id'], $this->request->post['title'], $this->request->post['comment']);
