...
class ControllerCatalogInformation extends Controller {
	...
	protected function getForm() {
        ...
        if (isset($this->request->post['image'])) {
            ...
            $data['image'] = $this->model_catalog_information->getInformationsImages($this->request->get['information_id']);
        } else {
            $data['image'] = '';
        }
        ...
        } elseif (!empty($information_info) && is_file(DIR_IMAGE . $this->model_catalog_information->getInformationsImages($this->request->get['information_id']))) {
            $data['thumb'] = $this->model_tool_image->resize($this->model_catalog_information->getInformationsImages($this->request->get['information_id']), 100, 100);
        } else {
        ...
        if (isset($this->request->post['information_image'])) {
            ...
            $product_images = $this->model_catalog_information->getInformationsImages($this->request->get['information_id']);
        } else {
