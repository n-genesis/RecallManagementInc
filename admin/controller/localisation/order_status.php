...
class ControllerLocalisationOrderStatus extends Controller {
	...
	protected function getList() {
		...
		$data['results'] = sprintf($this->language->get('text_pagination'), ($order_status_total) ? (($page - 1) * 15) + 1 : 0, ((($page - 1) * 15) > ($order_status_total - 15)) ? $order_status_total : ((($page - 1) * 15) + 15), $order_status_total, ceil($order_status_total / 15));
