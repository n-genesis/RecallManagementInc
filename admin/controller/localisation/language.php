...
class ControllerLocalisationLanguage extends Controller {
	...
	protected function getList() {
		...
		$data['results'] = sprintf($this->language->get('text_pagination'), ($language_total) ? (($page - 1) * 5) + 1 : 0, ((($page - 1) * 5) > ($language_total - 5)) ? $language_total : ((($page - 1) * 5) + 5), $language_total, ceil($language_total / 5));
