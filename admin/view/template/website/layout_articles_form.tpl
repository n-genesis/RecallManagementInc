<?php echo $header; ?>
  <div class="block-header">
    ...
    <div class="button-group">
      <button type="submit" form="form-information" title="<?php echo $button_delete; ?>" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary waves-effect">
          <i class="material-icons">save</i>
          <span class="text-uppercase"><?php echo $button_save; ?></span>
      </button>
    
    <a href="<?php echo $cancel; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="btn btn-default">
      <i class="material-icons">keyboard_return</i>
      <span class="text-uppercase"><?php echo $button_cancel; ?></span>
    </a>
    </div>
  </div>
  <section class="">
          ...
          <div class="body">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
              ...
              <ul class="nav nav-tabs tab-nav-right" role="tablist">
                <li role="presentation" class="active"><a href="#tab-general" data-toggle="tab"><?php echo $tab_general; ?></a></li>
                <li role="presentation"><a href="#tab-data" data-toggle="tab"><?php echo $tab_data; ?></a></li>
                <li role="presentation"><a href="#tab-design" data-toggle="tab"><?php echo $tab_design; ?></a></li>
                <li role="presentation"><a href="#tab-image" data-toggle="tab"><?php echo $tab_image; ?></a></li>
              </ul>
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="tab-general">
                  ...
                  <div class="tab-content">
                    <?php foreach ($languages as $language) { ?>
                    <div role="tabpanel" class="tab-pane fade in" id="language<?php echo $language['language_id']; ?>">
                ...
                <div class="tab-pane" id="tab-data">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-bottom"><span data-toggle="tooltip" title="Add to top menu">Top</span></label>
                    <div class="col-sm-10">
                      <div class="checkbox">
                        <label>
                          <?php if ($top) { ?>
                          <input type="checkbox" name="top" value="1" checked="checked" id="input-bottom" />
                          <?php } else { ?>
                          <input type="checkbox" name="top" value="1" id="input-bottom" />
                          <?php } ?>
                          &nbsp; </label>
                      </div>
                    </div>
