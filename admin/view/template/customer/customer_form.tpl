                    ...
                    <div class="tab-pane active" id="tab-customer">
                      ...
                      <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                          ...
                          <button type="button" class="btn bg-green waves-effect" onclick="window.open('https://hangouts.google.com/?action=chat&pn=%2B1<?php echo $telephone; ?>&hl=en','googlevoice','width=950,height=800'); return false;">
...
$('#button-history').on('click', function(e) {
	...
	$.ajax({
		...
		data: 'comment=' + encodeURIComponent($('#tab-history textarea[name=\'comment\']').val()) +
		      '&title=' + encodeURIComponent($('#tab-history input[name=\'title\']').val())
		,
		beforeSend: function() {
