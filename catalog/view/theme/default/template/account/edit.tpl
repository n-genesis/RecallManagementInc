...
<div class="pt-2 pb-5 min-height">
  ...
  <?php $align = 'NO'; ?>
  <?php } else { ?>
  <?php $align = 'justify-content-center'; ?>
  <?php } ?>
  <div class="row <?php echo $align; ?>">
    ...
    <?php $class = 'col-md-6 col-sm-12'; ?>
    <?php } ?>
    <div class="<?php echo $class; ?> custom-form">
      <div class="form-wrapper">
      <h1 class="title-underline"><span class="im im-icon-Pen-5" style="font-size: 28px;"></span> <?php echo $heading_title; ?></h1>
