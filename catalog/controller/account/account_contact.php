<?php
class ControllerAccountAccountContact extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('account/account_contact');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('account/account_contact/success'));
		}
		...
		$this->response->setOutput($this->load->view('account/account_contact', $data));
	}
