<?php
class ControllerAccountClaim extends Controller {
	public function index() {
	    $this->load->language('account/claim');
        
		if (!$this->customer->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('account/claim', '', true);
		...
		$this->response->setOutput($this->load->view('account/claim_list', $data));
	}
